                            ...
                            <nav className="menu">
                                <ul>
                                    <li className="type-1 active">
                                        <a href="#">home<span className="fa fa-angle-down" /></a>
                                    ...
                                    <li className="type-1"><a href="#">Hotels<span className="fa fa-angle-down" /></a>
                                        <ul className="dropmenu">
                                    ...
                                    <li className="type-1"><a href="#">Flights<span className="fa fa-angle-down" /></a>
                                        <ul className="dropmenu">
                                    ...
                                    <li className="type-1"><a href="#">Cars<span className="fa fa-angle-down" /></a>
                                        <ul className="dropmenu">
                                    ...
                                    <li className="type-1"><a href="#">Cruises<span className="fa fa-angle-down" /></a>
                                        <ul className="dropmenu">
                                    ...
                                    <li className="type-1"><a href="#">Pages<span className="fa fa-angle-down" /></a>
                                        <ul className="dropmenu">
                                            <li><a href="#">About <span className="fa fa-chevron-right" /></a>
                                                <ul className="dropmenu">
                                                    <li><a href="about_us.html">About us 1</a></li>
                                                    <li><a href="about_us_2.html">About us 2</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Service <span className="fa fa-chevron-right" /></a>
                                                <ul className="dropmenu">
                                                    <li><a href="services.html">Services 1</a></li>
                                                    <li><a href="services_2.html">Services 2</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Gallery <span className="fa fa-chevron-right" /></a>
                                                <ul className="dropmenu">
                                            ...
                                            <li><a href="#">Blog <span className="fa fa-chevron-right" /></a>
                                                <ul className="dropmenu">
                                            ...
                                            <li><a href="#">Layouts <span className="fa fa-chevron-right"></span></a>
                                                <ul className="dropmenu">
                                                    <li><a href="page_layout_left_sidebar.html">Layouts Left Sidebar</a>
                                                    </li>
                                            ...
                                            <li><a href="#">Contact <span className="fa fa-chevron-right"></span></a>
                                                <ul className="dropmenu">
                                            ...
                                            <li><a href="#">404 page <span className="fa fa-chevron-right"></span></a>
                                                <ul className="dropmenu">
                                    ...
                                    <li className="type-1"><a href="#">Shortcodes<span
                                        ...
                                        <ul className="dropmenu">
                                            ...
                                            <li>
                                                <a href="#">Listing Styles<span className="fa fa-chevron-right"></span></a>
                                                <ul className="dropmenu">
